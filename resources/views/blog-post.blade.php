		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 align-self-center p-static order-2 text-center">
					<h1 class="col-md-12 align-self-center p-static order-2 text-center">Título de la publicación</h1>
				</div>
...
<div class="post-image ml-0">
							<a href="blog-post.html">
								<img src="https://i1.wp.com/www.lotus-happiness.com/wp-content/uploads/2014/05/Prayer_slider-1200-x-500.jpg?fit=1024%2C426&ssl=1" class="img-fluid img-thumbnail img-thumbnail-no-borders rounded-0" alt="" />
							</a>
						</div>
